...
import 'package:mvvm_flutter_boilerplate/core/db/tables/expenses_table.dart';
...
@DriftDatabase(
  tables: [Products, Transactions, TransactionDetails, Expenses],
  daos: [ProductDao, TransactionDao, ExpenseDao],
)
